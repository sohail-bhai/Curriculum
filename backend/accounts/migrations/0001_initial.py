    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('FACULTY', 'Faculty'), ('HOD', 'Head of Department'), ('ACADEMIC', 'Academic Office / Associate Director'), ('BOS', 'Board of Studies'), ('DEAN', 'Dean'), ('ADMIN', 'System Admin')], db_index=True, default='FACULTY', max_length=20)),
